...
pub fn render_text_regular<'a, F: ThreadSafeFont>(text: impl AsRef<str>, size: f32, x: i32, y: i32, h_align: HAlign, v_align: VAlign, foreground: Color, canvas: &mut Canvas<Window>, texture_creator: &'a TextureCreator<WindowContext>, text_cache: &mut TextCache<'a, F>) -> Result<(), RenderTextError> {
